...
import { FiUploadCloud, FiPaperclip, FiX, FiSave, FiLoader } from 'react-icons/fi';
    ...
    try {
      ...
      if (filesToDelete.length > 0) {
        const filePathsToDelete = filesToDelete.map(url => {
          ...
          return `${session.user.id}/${parts[parts.length - 1]}`;
        });
      ...
      // 3. Gabungkan URL file dan perbarui database
